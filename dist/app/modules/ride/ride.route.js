...
router.post("/request", (0, checkAuth_1.checkAuth)(user_interface_1.Role.RIDER, user_interface_1.Role.ADMIN), (0, validateRequests_1.validateRequest)(ride_validation_1.createRideZodSchema), ride_controller_1.RideController.createRide);
